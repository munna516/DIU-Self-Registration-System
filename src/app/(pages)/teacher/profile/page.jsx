          ...
          <div className="grid gap-4 grid-cols-1 sm:grid-cols-2">
            ...
            <div className="flex items-center space-x-3 p-4 bg-gray-50 dark:bg-slate-700 rounded-lg">
              ...
              <div>
                ...
                <p className="font-medium">
                  {session?.data?.user?.teacherId || "Not available"}
                </p>
              </div>
            </div>
            ...
            <div className="flex items-center space-x-3 p-4 bg-gray-50 dark:bg-slate-700 rounded-lg">
              ...
              <div>
                ...
                <p className="font-medium">
                  {session?.data?.user?.designation || "Not available"}
                </p>
              </div>
            </div>
          ...
          <div className="pt-4">
            <Dialog  open={isDialogOpen} onOpenChange={setIsDialogOpen}>
              <DialogTrigger asChild>
                <Button variant="teacher" className="w-full dark:bg-slate-700 dark:text-white">
