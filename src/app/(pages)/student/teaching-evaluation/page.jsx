...
export default function TeachingEvaluation() {
  ...
  const { data: evaluationStatus, isLoading: isLoadingEvaluationStatus } =
    useQuery({
  ...
  const { data: previousSemesterData, isLoading: isLoadingPreviousSemester } =
    useQuery({
  ...
  const {
    ...
    enabled:
      !!selectedSemester && !!session?.user?.studentId && isEvaluationEnabled,
  });
          ...
          {isLoadingEvaluationStatus || isLoadingPreviousSemester ? (
            ...
            <>
                  ...
                  >
                    ...
                    <SelectContent>
                      {previousSemesterData?.previousSemester && (
                        <SelectItem
                          value={previousSemesterData.previousSemester}
                        >
                          {previousSemesterData.previousSemester}
                        </SelectItem>
                      )}
              ...
              {isLoadingCourses ? (
                ...
                <div className="text-center py-8">
                  <div className="text-lg font-semibold text-gray-600 dark:text-gray-400">
                    No courses found for {selectedSemester}. Please make sure
                    you were enrolled in courses for this semester.
                  </div>
                </div>
              ) : null}
              ...
              {showForm && selectedCourse && (
                ...
                >
                  <div
                    className="bg-white dark:bg-slate-800 rounded-lg p-6 max-w-4xl w-full mx-4 max-h-[90vh] overflow-y-auto"
